...
<table style="font-size: .8rem; margin-top: -1rem;">
    <tr style="border: 1px solid black; background-color: rgba(0,0,0,0.1); font-weight: bold; font-size: 1rem;">
        <td style="color: black; text-align: center;border: 1px solid black;">***** ON-SITE APPLICATION #{{ $registrant->id }} *****</td>
    </tr>
</table>
