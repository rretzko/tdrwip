<div>
    ...
    <div>
            ...
            <div class="mt-1 flex items-center space-x-4 mb-1">
                <div class="relative inline-block h-12 w-12 rounded-full overflow-hidden bg-gray-100">
                    @if($user->profile_photo_path ?: false)
                        <div>
                            <img class="absolute w-full h-full inset-0 object-cover" src="{{ '/storage/'.$user->profile_photo_path }}" />
                        </div>
        ...
        <div class="flex items-center justify-end">
            ...
            <x-buttons.button-link wire:click="savePhoto" class="bg-black text-white p-2 ml-1 rounded">Save Photo</x-buttons.button-link>
    ...
    <footer class="mt-4 bg-gray-200 flex justify-end space-x-2 p-2">
        ...
        <x-buttons.button wire:click="save" >Update {{ ucwords($user->person->fullname) }}</x-buttons.button>
    </footer>
