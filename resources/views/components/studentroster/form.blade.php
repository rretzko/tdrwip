...
<div class="{{$displayform ? 'w-8/12 -ml-4 bg-blue-50 text-black' : 'hidden'}}">
    @if($student)
        <div>
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-2 sm:col-span-2">
                                                <label for="last" class="block text-sm font-medium text-gray-700">Middle
                                                    name</label>
                                                <input wire:model="middle" type="text" name="middle" id="middle" autocomplete="family-name"
                                                       class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            </div>
                                            ...
                                            <div class="col-span-6 sm:col-span-4">
                                                <label for="pronoun_id"
                                                       class="block text-sm font-medium text-gray-700">
                                                    Preferred Pronoun
                                                </label>
                                                <select model:wire="pronoun_id" name="pronoun_id">
                                                    @foreach($pronouns AS $pronoun)
                                                        <option value="{{ $pronoun->id }}">{{ $pronoun->descr }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
