...
<div>
    ...
    <div class="hidden sm:block pt-2 mb-3">
        <nav class="relative z-0  border-b-2 border-gray-200 flex divide-x divide-gray-200 mx-auto" style="max-width:90%;" aria-label="Tabs">
            ...
            @if(is_a($student, 'App\Models\Student') && (! $student->user_id)) {{-- NEW STUDENT CREATION --}}
                <a href="#"
                ...
                >
                    <div class="flex flex-col">
                        ...
                        <span class="sm:hidden lg:block ml-1 pt-0.5 text-xs">Profile</span>
            ...
            @else
                <a href="#"
                    ...
                    class="tab text-gray-500 hover:text-gray-700 group relative min-w-0 flex-1 overflow-hidden bg-white py-4 px-4 text-sm font-medium text-center hover:bg-gray-50 focus:z-10" aria-current="page"
                    title="Biography"
                >
                    <div class="flex flex-col">
                        ...
                        <span class="sm:hidden lg:block ml-1 pt-0.5 text-xs">Biography</span>
                    </div>
                ...
                >
                    <div class="flex flex-col">
                        ...
                        <span class="sm:hidden lg:block ml-1 pt-0.5 text-xs">Voice & Instrument</span>
                ...
                >
                    <div class="flex flex-col">
                        ...
                        <span class="sm:hidden lg:block ml-1 pt-0.5 text-xs">Email & Phone</span>
                ...
                >
                    <div class="flex flex-col">
                        ...
                        <span class="sm:hidden lg:block ml-1 pt-0.5 text-xs">Home Address</span>
                        <span aria-hidden="true" class="bg-transparent absolute inset-x-0 bottom-0 h-0.5"></span>
                ...
                >
                    <div class="flex flex-col">
                        ...
                        <span class="sm:hidden lg:block ml-1 pt-0.5 text-xs">Parent & Guardian</span>
                        <span aria-hidden="true" class="bg-transparent absolute inset-x-0 bottom-0 h-0.5"></span>
