                        ...
                        <div class="my-2 overflow-x-auto sm:mx-2 lg:mx-2 ">
                            ...
                            <div class="flex flex-col">
                                ...
                                <section class="mt-4">
                                    ...
                                    <div class="px-4">
                                        <h4 class="font-bold mb-4 px-4" style="background-color: rgba(0,0,0,0.1);">Payment (testing to Sandbox account)</h4>
                                        <div class="m-auto" style="width: 12rem;">
                                            <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank" >
                                                ...
                                                <input type="hidden" name="custom" value="{{ $eventversion->id.'.'.auth()->id().'.' }}1.00" >
                                                <!-- Specify a subscribe button -->
                                                <input type="hidden" name="cmd" value="_xclick" >
                                                <!-- Identify the registrant -->
                                                <input type="hidden" name="item_name" value="{{ $eventversion->name }}" >
                                                <input type="hidden" name="item_number" value="{{ $eventversion->id.'.'.auth()->id().'.' }}1.00" >
